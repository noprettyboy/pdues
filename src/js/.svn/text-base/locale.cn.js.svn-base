...
/*--> FOR INDEX(ALL DASHBOARD EXCEPT SENSOR PART) PAGE and SOME PROMPT FOR RESET ACTION BEGIN <--*/
  ...
  MODEL.dashboard = {
    ...
    voltagerms: "电压, RMS (V)",
    voltenergy: "电能 (kWh)",
    pdupowerenergy: "功率",//"PDU 电能",
    externalsensor: "外部传感器",
    externalsensortype: "类型",
    sensorname: "传感器名字",
    pduname: "PDU 名字",
    location: "位置",
    value: "值"
...
/*--> FOR SOME VALIDATE PROMPT BEGIN <--*/
  window.VALID = {
    ...
    , oldpwd: "原密码错误"
    //add by zzw begin
    , greaterC1: "上临界值 - 1A 应大于或等于上临界警告!"
    , greaterC2: "上临界警告 - 1A 应大于或等于下临界警告!"
    , greaterC3: "下临界警告 - 1A 应大于或等于下临界值!"
    , greaterV1: "上临界值 - 2V 应大于或等于上临界警告!"
    , greaterV2: "上临界警告 - 4V 应大于或等于下临界警告!"
    , greaterV3: "下临界警告 - 2V 应大于或等于下临界值!"
    , greaterP1: "上临界值 - 100W 应大于或等于上临界警告!"
    , greaterP2: "上临界警告 - 200W 应大于或等于下临界警告!"
    , greaterP3: "下临界警告 - 100W 应大于或等于下临界值!"
    , greaterE1: "上临界值 - 100W 应大于或等于上临界警告!"
    , greaterE2: "上临界警告 - 200W 应大于或等于下临界警告!"
    , greaterE3: "下临界警告 - 100W 应大于或等于下临界值!"
    , greaterE4: "上临界值 - 3% 应大于或等于上临界警告!"
    , greaterE5: "上临界警告 - 6% 应大于或等于下临界警告!"
    , greaterE6: "下临界警告 - 3% 应大于或等于下临界值!"
    //add by zzw end
  };
